...
|---|---|---|---|
| `adapter_kind` | `"Summit"` \| `{"KCan":{"serial":null}}` | — | Which hardware adapter to use |
| `port` | string | — | Adapter channel / interface name (Summit: `"1"` = PCAN_USBBUS1; SocketCAN: `"can0"`; unused for KCAN) |
