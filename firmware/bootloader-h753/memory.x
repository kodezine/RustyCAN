/* STM32H753ZI bootloader linker script.
 *
 * Identical partition layout to bootloader-h743 — both chips have the same
 * 2 MB flash topology (two 8×128 KB banks).
 *
 * Partition layout (full 2 MB flash):
 *   BOOTLOADER  : 0x08000000  128 KB  Bank1 sector 0   — this binary
 *   ACTIVE      : 0x08020000  896 KB  Bank1 sectors 1–7 — KCAN app
