...
- 🔌 **Multi-adapter support** — Summit, KCAN Dongle (STM32H753ZI), Apex USB-CAN, SocketCAN on Linux, or **KCanNet** (encrypted TCP — scan the device QR code to connect over LAN without a USB cable)
